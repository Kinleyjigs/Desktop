...
// HomePage component that uses the Reply component to display tells
const HomePage = () => {
  // Example tells array; replace with actual data source
  const tells = [
    {
      message: "I love learning new things.",
      username: "CuriousMind",
      timeAgo: "1 day ago",
      avatarUrl: "/path/to/avatar.jpg", // Optional; can be omitted
    },
    {
      message: "What's your favorite book?",
      username: "BookLover",
      timeAgo: "2 days ago",
      avatarUrl: "/another/path/to/avatar.jpg", // Optional; can be omitted
    },
    // Add more tells as needed
  ];
